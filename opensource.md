...
<div class="section">
  ...
  <div class="project">
    ...
    <span>TCP challenge ACK for duplicate ACKs in LAST-ACK state (RFC 9293 §3.10.7.4). Fixes silent discard of stale acknowledgments by sending a challenge ACK response, symmetric with the existing SND.NXT handling. Merged.</span>
  </div>
</div>
...
<div class="section">
  ...
  <div class="project">
    ...
    <span>Align ring buffer reads to ADC scan sequence length. Fixes channel value shifting after DMA overrun recovery in STM32 ADC ring-buffered mode by snapping read pointers to scan-sequence boundaries. Merged.</span>
  </div>
</div>
